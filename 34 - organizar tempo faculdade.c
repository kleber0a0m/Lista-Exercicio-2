/*
Você precisa organizar melhor seu tempo para conseguir estudar todas as disciplinas da faculdade e não
ficar sobrecarregado(a) no período de provas. Para ajudá-lo(a) nesta tarefa, um amigo sugeriu que você
contabilize as horas que tem dedicado para estudar cada disciplina (fora da sala de aula) em uma grade
...
Com base nas informações de sua grade elaborada, crie funções para responder as questões abaixo:
